...
export const componentKey = 'NURSE_MANAGEMENT/NURSE_LISTING';
...
const { actions } = store.reducerManager.add({
    ...
    addedReducers: {
        ...
        //     state.dataToUpdate = { ...state.dataToUpdate, addresses:[action.payload] };
        // },
        setAutoCompleteAddressFields: (state, action) => {
    ...
    initialReducerState: {
        ...
        PaginationState: {
            ...
            Role: 'RN',
            Status: 'Active',
            NursesRole: { value: 'RN', label: 'Registered Nurse' }
        },
        dataToUpdate: {
