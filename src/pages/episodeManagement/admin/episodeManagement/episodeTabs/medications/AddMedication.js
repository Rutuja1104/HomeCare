...
import { componentKey, setAddNewMedicationDetails, setIsMedicationCreated, setMedicationDetails, setRemoveNewMedicationDetails } from '../../AdminEpisodeManagementSlice';
...
import { getMedicationDetailsById, postMedications, updateMedicationDetails } from '../../AdminEpisodeManagementSaga';
...
const AddMedication = () => {
    ...
    useEffect(() => {
        if (isMedicationCreated) {
            ...
            navigate(`/${EPISODE_MANAGEMENT.EPISODE_MANAGEMENT}/${EPISODE_MANAGEMENT.CHILD_ROUTS.EPISODE_DETAILS}/${episodeId}?at=4`)
        }
    }, [isMedicationCreated])
