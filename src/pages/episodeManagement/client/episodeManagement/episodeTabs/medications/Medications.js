...
import { deleteMedication, getAllMedications } from '../../ClientEpisodeManagementSaga';
import { useNavigate, useParams } from 'react-router-dom';
import { componentKey, setMedicationPaginationState, setSelectedMedicationToDelete, setSelectedMedications, setShowDeleteMedicationModal } from '../../ClientEpisodeManagementSlice';
    ...
    const ACTION_BUTTONS = [
        {
            text: 'View/Edit',
            onClickCb: (row) => {
                navigate(`/${CLIENT_EPISODE_MANAGEMENT.EPISODE_MANAGEMENT}/${CLIENT_EPISODE_MANAGEMENT.CHILD_ROUTS.ADD_NEW_MEDICATION}/${episodeId}?mi=${row.id}`)
            }
        },
        {
            text: 'Delete',
    ...
    const DROPDOWN_BUTTON_ACTION = [
        {
            ...
            onClickCb: () => navigate(`/${CLIENT_EPISODE_MANAGEMENT.EPISODE_MANAGEMENT}/${CLIENT_EPISODE_MANAGEMENT.CHILD_ROUTS.ADD_NEW_MEDICATION}/${episodeId}`)
        }
    ];
