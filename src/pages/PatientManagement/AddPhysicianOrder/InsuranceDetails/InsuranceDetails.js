...
const InsuranceDetails =  () => {
    ...
    return (
        <>
            <div className="insurance-details-container">
                    ...
                    <div key={index} className="mt-4">
                        ...
                        <div className="from-to-date-block">
                            ...
                            <div className="block">
                                <TextInput
                                    type="text"
                                    placeHolder={'Please enter your relation with patient'}
                            ...
                            <div className="">
                                <FileUpload
                                    ...
                                    onRemoveFilesCb={(idx, s3Url) => {
                                        if (s3Url) {
                                            dispatch(deleteDocumentFromS3AndDatabase({
                                                s3Url,
                                                documentType: 'insurance reports'
                                            }));
                                        }
                ...
                <div className="nextbuttons">
                    <Button
                        ...
                        onClickCb={() => {
                            dispatch(setActivePhysicianPatientIntakeStep(0));
                        }}
                    >
                        Back
                    </Button>
                    <Button
                        ...
                        onClickCb={() => {
                            if(cardDetails.FullName && cardSavedStatePhysician) {
                                ...
                                if (!GeneralValidator.validateRequiredFieldsArray(insuranceDetails)) {
                                    ...
                                    dispatch(setActivePhysicianPatientIntakeStep(2));
                                } else {
            ...
            {isEligible && !cardSavedStatePhysician && (
