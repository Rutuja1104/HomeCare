...
import { postFaceToFace } from '../phsyicianOrderSaga';
...
const FaceToFaceForm = () => {
    ...
    const handleSaveSignatureClick = (sign, isCanvasEmpty) => {
        ...
        if (!GeneralValidator.validateRequiredFields(faceToFace)) {
            if (!isCanvasEmpty) {
                dispatch(setPatientPhysicianIntakeSign(sign));
                dispatch(
                    postFaceToFace({
                        agencyId,
                        physicianId,
                ...
                // dispatch(setActivePhysicianPatientIntakeStep(5));
            } else {
                ...
                <div className="mt-4">
                    ...
                    <div>
                        ...
                        <div className="block">
                            <TextInput
                                type="text"
                                placeHolder={'Drake'}
                                // onChangeCb={({ target: { name, value } }) => dispatch(setfaceToFace({ name, value }))}
                    ...
                    <div>
                        ...
                        <SignaturePad
                            ...
                            savedSignature={patientPhysicianIntakeSign}
                            isPreviousAllowed
                            onPrevCb={() => {
