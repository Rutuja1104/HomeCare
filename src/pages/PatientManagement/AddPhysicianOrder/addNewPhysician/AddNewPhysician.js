                ...
                <div>
                    ...
                    <div className="physician-details-block">
                        <div className="block1">
                            <SelectDropdown
                                type="text"
                                placeHolder={'Please search physician by name'}
                        ...
                        onClickCb={() => {
                            ...
                            if (
                                ...
                                if (patientDropdownDetails.patientPhysician.value === '') {
                                    ...
                                    dispatch(
                                        emergencyContact({ agencyId, patientId, emergencyDetails, referralDetails,token })
                                    );
                        ...
                        <div className="fileds">
                            ...
                            <div className="button">
                                <Button
                                    type={BUTTON_TYPE.PRIMARY}
                                    onClickCb={() => {
                                        if (npi !== '' || (physicianFirstName !== '' && physicianLastName !== '')) {
                                            dispatch(
                                                getPhysicianByNameOrNumber({
                                                    npi,
                                                    physicianFirstName,
                                            ...
                                            toast.error('Please enter NPI or firstname and lastname');
                                        }
                                    }}
                                >
                                    Verify
